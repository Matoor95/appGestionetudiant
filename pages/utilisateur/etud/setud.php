...
echo "<tr><td><img src='images/".$ligne['photo']."' width='70' height='70' /></td><th scope='row'>".$ligne['prenom']."</th><th scope='row'>".$ligne['nom']."</th><td>".$ligne['nom_classe']."</td><td><form action='tsetud.php' method='post'><input type='hidden' name='nume' value='".$ligne['nume']."' /><input type='submit' value='  SUPPRIMER  ' class='btn btn-primary btn-large'/>
</form></td></tr>";
}
?>
</table>
